...
TEST_CASE("Different pattern sizes") {
  ...
  SUBCASE("17 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE, 0xAA, 0xBB,
                           0xCC, 0xDD, 0xEE, 0xFF, 0x00, 0x11, 0x22,
                           0x33>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00,
                                   0x11, 0x22, 0x32>::compare(test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBA, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCC, 0xDD, 0xEE, 0xFF, 0x00,
                                   0x11, 0x22, 0x33>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCF, 0xDD, 0xEE, 0xFA, 0x00,
                                   0x11, 0x22, 0x32>::compare(test_arr));
  }

  SUBCASE("11 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE, 0xAA, 0xBB,
                           0xCC, 0xDD>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCC, 0xDA>::compare(test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEA, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCC, 0xDD>::compare(test_arr));
  }

  SUBCASE("10 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE, 0xAA, 0xBB,
                           0xCC>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCA>::compare(test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBF, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB, 0xCC>::compare(test_arr));
  }

  SUBCASE("9 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE, 0xAA,
                           0xBB>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBF>::compare(test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAF, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA, 0xBB>::compare(test_arr));
  }

  SUBCASE("8 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                           0xAA>::compare(test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAF>::compare(test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAF, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE,
                                   0xAA>::compare(test_arr));
  }

  SUBCASE("7 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEE>::compare(
        test_arr));

    REQUIRE_FALSE(
        function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF, 0xEF>::compare(
            test_arr));
    REQUIRE_FALSE(
        function_compare<0xDE, 0xAD, 0xBE, 0xEA, 0xC0, 0xFF, 0xEE>::compare(
            test_arr));
  }

  SUBCASE("6 bytes") {
    CHECK(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFF>::compare(
        test_arr));

    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBE, 0xEF, 0xC0, 0xFA>::compare(
        test_arr));
    REQUIRE_FALSE(function_compare<0xDE, 0xAD, 0xBA, 0xEF, 0xC0, 0xFF>::compare(
        test_arr));
  }
}
...
TEST_CASE("4 byte pattern") {
  ...
  CHECK(function_compare<0xFF, ANY, 0xBB, 0xCC>::compare(test_arr));
}